...
BorderSurface {
  ...
  Item {
    ...
    z: 10
    opacity: (hoverTracker.hovered || closeMouse.containsMouse) ? 1.0 : 0.55
    ...
    Rectangle {
      ...
      Text {
        ...
        text: "󰅖"
        color: closeMouse.containsMouse ? Color.urgent : root.dimColor
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      Layout.rightMargin: Style.space(30)
