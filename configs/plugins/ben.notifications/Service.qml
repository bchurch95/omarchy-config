...
Item {
  ...
  Variants {
    ...
    PanelWindow {
      ...
      screen: modelData
      readonly property bool isVirtualScreen: !!modelData && !!modelData.name && (modelData.name.indexOf("VIRTUAL") === 0 || modelData.name.indexOf("HEADLESS") === 0)
      visible: popupModel.count > 0 && !isVirtualScreen
